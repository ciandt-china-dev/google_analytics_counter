...
/**
 * @file
 * Contains \Drupal\google_analytics_counter\Form\GoogleAnalyticsCounterAdminAuthForm.
 */
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    if ($account && $account->isAuthenticated()) {
      ...
      $form['ga']['profile_id'] = array(
        ...
        '#description' => t('Choose your Google Analytics profile. The currently active profile is: %profile',
